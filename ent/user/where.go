...
func HasOwnedNamespaces() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(OwnedNamespacesTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2M, true, OwnedNamespacesTable, OwnedNamespacesPrimaryKey...),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}
...
func HasOwnedNamespacesWith(preds ...predicate.Namespace) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(OwnedNamespacesInverseTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2M, true, OwnedNamespacesTable, OwnedNamespacesPrimaryKey...),
		)
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
